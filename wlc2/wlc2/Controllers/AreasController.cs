...
namespace wlc2.Controllers
{
    ...
    public class AreasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,RenatesCode")] Area area)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,RenatesCode")] Area area)
        {
            if (id != area.Id)
            {
                return NotFound();
