...
namespace wlc2.Controllers
{
    ...
    public class LanguagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Alpha2Code")] Language language)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Alpha2Code")] Language language)
        {
            if (id != language.Id)
            {
                return NotFound();
