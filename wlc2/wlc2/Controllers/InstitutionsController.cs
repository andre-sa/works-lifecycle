...
namespace wlc2.Controllers
{
    public class InstitutionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Site")] Institution institution)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Site")] Institution institution)
        {
